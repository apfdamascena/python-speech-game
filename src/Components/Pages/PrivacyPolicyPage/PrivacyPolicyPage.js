            ...
            <div id="boxAbout">
                ...
                <div className="mainBox">
                    <div id="contentAbout2">
                        ...
                        <p id="box-inside">
                        - The audios will be used, exclusively, for a research of scientific initiation, which has the objective of programming by voice. We do not have the identification of the people who sent the audio, we don't use these audios for other purposes. We just want to build a large database that allows for the continuation of this research.<br/>
